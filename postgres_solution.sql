...
COPY raw_csv_input FROM '/Users/josh/proj/csvdemo/example.csv' with CSV HEADER;
...
BEGIN
  ...
  LOOP
    ...
    EXECUTE format('COPY ' ||
                   ...
                   'TO /Users/josh/proj/csvdemo/target/%.csv WITH FORMAT CSV', quote_ident(company), quote_ident(company));
  END LOOP;
